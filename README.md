# Personal Blog
This is my personal blog built from [Hugo](https://gohugo.io/) and hosted on [GitHub Pages](https://pages.github.com/).

## Requirements
You will need Hugo installed locally. You can install it on MacOS with brew:
```bash
brew install hugo
```
...
--bind=0.0.0.0 --baseURL=http://127.0.0.1:1313
```
